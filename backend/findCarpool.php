...
function getCarpoolList($data, $pdo)
{
  ...
  HTML;
    ...
    HTML;
      ...
      $processed = [
        'carpoolDay' => $carpoolDay,
        'carpoolTime' => $carpoolTime,
        'rating' => $rating,
        'pickup' => $pickup,
        'destination' => $destination,
        'passengerAmt' => $passengerAmt,
        'ratingsAmt' => $ratingsAmt
      ];

      $modal .= createModal($carpool, $vehicle, $processed);
    }
  } else {
    if ($data['type'] == 'filteredList') {
...
function createModal($carpool, $vehicle, $processed)
{
  $modal = "";
          ...
          <div class="row flex-column">
            <div class="col-12 d-flex mb-3">
              ...
              <div class="col-6 d-flex flex-column p-3 align-items-center justify-content-center">
                  ...
                  <h5 style="font-weight:600; color:var(--primary)">{$carpool['name']}</h5>
                  <div class="d-flex justify-content-center mb-2">
                    <p class="m-0" style="font-weight:600">{$processed['rating']}</p>
                    <i class="bi bi-star-fill mx-1" style="color:#F6931A"></i>
                    <p class="text-muted m-0" style="font-size:0.857rem; font-weight:500">({$processed['ratingsAmt']} Ratings)</p>
                  </div>
                <span class="badge rounded-pill shadow px-3">{$vehicle['vehicleNo']}</span>
              </div>
              ...
              <div class="col-6 d-flex flex-column">
                <div class="d-flex flex-column mb-3">
                  ...
                  <p class="m-0">{$processed['carpoolTime']}</p>
                </div>
                <div class="d-flex flex-column mb-3">
                  <h6 class="m-0">Date <i class="ms-2 bi bi-calendar-week"></i></h6>
                  <p class="m-0">{$carpool['carpoolDate']} ({$processed['carpoolDay']})</p>
                </div>
                <div class="d-flex flex-column mb-3">
            ...
            <div class="col-12 d-flex flex-column mt-3">
              ...
              <div class="d-flex justify-content-center mt-4">
                <button type="submit" id="newCarpoolBtn" class="btn btn-primary shadow px-4">Hop On!</button>
              </div>
            </div> 
          </div>
        </div>
