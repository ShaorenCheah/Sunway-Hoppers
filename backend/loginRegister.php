...
// Register Process
  ...
  if ($result) {
    ...
    // Insert new user
    $query   = "INSERT INTO user (accountID, name, phoneNo, gender, dob, bio, rewardPoints, rating, carRules, profilePic) VALUES (:accountID, :name, :phoneNo, :gender, :dob, null, 0, 0, null, './images/person.png')";
    $stmt = $pdo->prepare($query);
    $stmt->bindParam(':accountID', $accountID, PDO::PARAM_STR);
